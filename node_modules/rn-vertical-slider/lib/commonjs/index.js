...
class VerticalSlider extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "_changeState", value => {
      ...
      }), _reactNative.Animated.timing(this.state.ballHeight, {
    ...
    this.state = {
      ...
      ballHeight: new _reactNative.Animated.Value(0),
      panResponder
    };
  }
  ...
  render() {
    ...
    })), showBallIndicator ? /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
    ...
    }, renderIndicator ? renderIndicator(value) : /*#__PURE__*/React.createElement(_reactNative.Text, {
