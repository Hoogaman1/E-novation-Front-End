...
&nbsp;
const RNOneSignal = <span class="cstat-no" title="statement not covered" >NativeModules.OneSignal;</span>
const eventManager = <span class="cstat-no" title="statement not covered" >new EventManager(RNOneSignal);</span>
&nbsp;
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setAppId(appId: string): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setAppId(appId);</span>
  }
&nbsp;
  /* O B S E R V E R S */
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic addPermissionObserver(
    observer: (event: ChangeEvent&lt;PermissionChange&gt;) =&gt; void,
  ): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    isValidCallback(observer);</span>
<span class="cstat-no" title="statement not covered" >    RNOneSignal.addPermissionObserver();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.addEventHandler&lt;PermissionChange&gt;(</span>
      PERMISSION_CHANGED,
      observer,
    );
  }
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic clearPermissionObservers(): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    RNOneSignal.removePermissionObserver();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.clearEventHandler(PERMISSION_CHANGED);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic addSubscriptionObserver(
...
<span class="cstat-no" title="statement not covered" >    isValidCallback(observer);</span>
<span class="cstat-no" title="statement not covered" >    RNOneSignal.addSubscriptionObserver();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.addEventHandler&lt;SubscriptionChange&gt;(</span>
      SUBSCRIPTION_CHANGED,
      observer,
    );
  }
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic clearSubscriptionObservers(): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    RNOneSignal.removeSubscriptionObserver();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.clearEventHandler(SUBSCRIPTION_CHANGED);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic addEmailSubscriptionObserver(
...
<span class="cstat-no" title="statement not covered" >    isValidCallback(observer);</span>
<span class="cstat-no" title="statement not covered" >    RNOneSignal.addEmailSubscriptionObserver();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.addEventHandler&lt;EmailSubscriptionChange&gt;(</span>
      EMAIL_SUBSCRIPTION_CHANGED,
      observer,
    );
  }
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic clearEmailSubscriptionObservers(): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    RNOneSignal.removeEmailSubscriptionObserver();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.clearEventHandler(EMAIL_SUBSCRIPTION_CHANGED);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic addSMSSubscriptionObserver(
...
<span class="cstat-no" title="statement not covered" >    isValidCallback(observer);</span>
<span class="cstat-no" title="statement not covered" >    RNOneSignal.addSMSSubscriptionObserver();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.addEventHandler&lt;SMSSubscriptionChange&gt;(</span>
      SMS_SUBSCRIPTION_CHANGED,
      observer,
    );
  }
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic clearSMSSubscriptionObservers(): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    RNOneSignal.removeSMSSubscriptionObserver();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.clearEventHandler(SMS_SUBSCRIPTION_CHANGED);</span>
  }
&nbsp;
  /* H A N D L E R S */
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setNotificationWillShowInForegroundHandler(
    handler: (event: NotificationReceivedEvent) =&gt; void,
  ): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    isValidCallback(handler);</span>
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setNotificationWillShowInForegroundHandler();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.setEventHandler&lt;NotificationReceivedEvent&gt;(</span>
      NOTIFICATION_WILL_SHOW,
      handler,
    );
  }
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setNotificationOpenedHandler(
...
<span class="cstat-no" title="statement not covered" >    isValidCallback(handler);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setNotificationOpenedHandler();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.setEventHandler&lt;OpenedEvent&gt;(NOTIFICATION_OPENED, handler);</span>
  }
&nbsp;
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic promptForPushNotificationsWithUserResponse(
...
&nbsp;
    let fallbackToSettings = <span class="cstat-no" title="statement not covered" >false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof fallbackToSettingsOrHandler === 'function') {</span>
      // Method was called like promptForPushNotificationsWithUserResponse(handler: function)
<span class="cstat-no" title="statement not covered" >      handler = fallbackToSettingsOrHandler;</span>
    } else <span class="cstat-no" title="statement not covered" >if (typeof fallbackToSettingsOrHandler === 'boolean') {</span>
      // Method was called like promptForPushNotificationsWithUserResponse(fallbackToSettings: boolean, handler?: function)
<span class="cstat-no" title="statement not covered" >      fallbackToSettings = fallbackToSettingsOrHandler;</span>
    }
    // Else method was called like promptForPushNotificationsWithUserResponse(), no need to modify
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!handler &amp;&amp; Platform.OS === 'ios') {</span>
<span class="cstat-no" title="statement not covered" >      handler = <span class="fstat-no" title="function not covered" >fu</span>nction () {};</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.promptForPushNotificationsWithUserResponse(</span>
      fallbackToSettings,
      handler,
    );
  }
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic registerForProvisionalAuthorization(
    handler: (response: boolean) =&gt; void,
  ): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
...
<span class="cstat-no" title="statement not covered" >      isValidCallback(handler);</span>
<span class="cstat-no" title="statement not covered" >      RNOneSignal.registerForProvisionalAuthorization(handler);</span>
    } else {
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic disablePush(disable: boolean): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.disablePush(disable);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic unsubscribeWhenNotificationsAreDisabled(unsubscribe: boolean): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Platform.OS === 'android') {</span>
<span class="cstat-no" title="statement not covered" >      RNOneSignal.unsubscribeWhenNotificationsAreDisabled(unsubscribe);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      console.log(</span>
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic enterLiveActivity(
    activityId: string,
    token: string,
    handler?: Function,
  ): void {
...
<span class="cstat-no" title="statement not covered" >    if (Platform.OS === 'ios') {</span>
<span class="cstat-no" title="statement not covered" >      RNOneSignal.enterLiveActivity(activityId, token, handler);</span>
    }
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic exitLiveActivity(activityId: string, handler?: Function): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
    // Only Available on iOS
<span class="cstat-no" title="statement not covered" >    if (Platform.OS === 'ios') {</span>
<span class="cstat-no" title="statement not covered" >      RNOneSignal.enterLiveActivity(activityId, handler);</span>
    }
  }
&nbsp;
  /* L O C A T I O N */
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  st</span>atic isLocationShared(): Promise&lt;boolean&gt; {
    // must return a promise
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return Promise.resolve(false);</span>
    }
<span class="cstat-no" title="statement not covered" >    return RNOneSignal.isLocationShared();</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setLocationShared(shared: boolean): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setLocationShared(shared);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic promptLocation(): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    //Supported in both iOS &amp; Android
<span class="cstat-no" title="statement not covered" >    RNOneSignal.promptLocation();</span>
  }
&nbsp;
  /* D E V I C E  I N F O */
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  st</span>atic async getDeviceState(): Promise&lt;DeviceState | null&gt; {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return Promise.resolve(null);</span>
    }
    const deviceState = <span class="cstat-no" title="statement not covered" >await RNOneSignal.getDeviceState();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Platform.OS === 'android') {</span>
<span class="cstat-no" title="statement not covered" >      deviceState.hasNotificationPermission =</span>
        deviceState.areNotificationsEnabled;
<span class="cstat-no" title="statement not covered" >      delete deviceState.areNotificationsEnabled;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return deviceState;</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setLanguage(
    language: string,
...
<span class="cstat-no" title="statement not covered" >      onSuccess = <span class="fstat-no" title="function not covered" >fu</span>nction () {};</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!onFailure) {</span>
<span class="cstat-no" title="statement not covered" >      onFailure = <span class="fstat-no" title="function not covered" >fu</span>nction () {};</span>
    }
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setLanguage(language, onSuccess, onFailure);</span>
  }
&nbsp;
  /* T A G S */
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic sendTag(key: string, value: string): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!key || (!value &amp;&amp; value !== '')) {</span>
<span class="cstat-no" title="statement not covered" >      console.error('OneSignal: sendTag: must include a key and a value');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.sendTag(key, value);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic sendTags(tags: { [key: string]: string }): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    let keys = <span class="cstat-no" title="statement not covered" >Object.keys(tags);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.sendTags(tags || {});</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic getTags(
    handler: (tags: { [key: string]: string } | null) =&gt; void,
  ): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    RNOneSignal.getTags(handler);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic deleteTag(key: string): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
...
<span class="cstat-no" title="statement not covered" >    RNOneSignal.deleteTags([key]);</span>
  }
&nbsp;
  /**
   ...
   * @param  {string[]} keys
   */
<span class="fstat-no" title="function not covered" >  st</span>atic deleteTags(keys: string[]): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!Array.isArray(keys)) {</span>
<span class="cstat-no" title="statement not covered" >      console.error('OneSignal: deleteTags: argument must be of array type');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.deleteTags(keys);</span>
  }
&nbsp;
  /* E M A I L */
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setEmail(
    email: string,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (emailAuthCode === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      emailAuthCode = null;</span>
    }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setEmail(email, emailAuthCode, handler);</span>
  }
&nbsp;
  /**
   ...
   * @param  {Function} handler
   */
<span class="fstat-no" title="function not covered" >  st</span>atic logoutEmail(handler?: Function): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.logoutEmail(handler);</span>
  }
&nbsp;
  /* S M S */
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setSMSNumber(
    smsNumber: string,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (smsAuthCode === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      smsAuthCode = null;</span>
    }
&nbsp;
    // Android workaround for the current issue of callback fired more than once
<span class="cstat-no" title="statement not covered" >    if (!handler &amp;&amp; Platform.OS === 'ios') {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setSMSNumber(smsNumber, smsAuthCode, handler);</span>
  }
&nbsp;
  /**
   ...
   * @param  {Function} handler
   */
<span class="fstat-no" title="function not covered" >  st</span>atic logoutSMSNumber(handler?: Function): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.logoutSMSNumber(handler);</span>
  }
&nbsp;
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic postNotification(
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.postNotification(</span>
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic clearOneSignalNotifications(): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Platform.OS === 'android') {</span>
<span class="cstat-no" title="statement not covered" >      RNOneSignal.clearOneSignalNotifications();</span>
    } else {
<span class="cstat-no" title="statement not covered" >      console.log(</span>
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic removeNotification(id: number): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Platform.OS === 'android') {</span>
<span class="cstat-no" title="statement not covered" >      RNOneSignal.removeNotification(id);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      console.log('removeNotification: this function is not supported on iOS');</span>
    }
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic removeGroupedNotifications(id: string): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Platform.OS === 'android') {</span>
<span class="cstat-no" title="statement not covered" >      RNOneSignal.removeGroupedNotifications(id);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      console.log(</span>
...
&nbsp;
   ...
   * @returns
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setLaunchURLsInApp(isEnabled: boolean): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Platform.OS === 'ios') {</span>
<span class="cstat-no" title="statement not covered" >      RNOneSignal.setLaunchURLsInApp(isEnabled);</span>
    } else {
<span class="cstat-no" title="statement not covered" >      console.log(</span>
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setExternalUserId(
    externalId: string,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof handlerOrAuth === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      RNOneSignal.setExternalUserId(externalId, null, handlerOrAuth);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!handler &amp;&amp; Platform.OS === 'ios') {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setExternalUserId(externalId, handlerOrAuth, handler);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic removeExternalUserId(handler?: (results: object) =&gt; void): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    // Android workaround for the current issue of callback fired more than once
<span class="cstat-no" title="statement not covered" >    if (handler === undefined &amp;&amp; Platform.OS === 'ios') {</span>
<span class="cstat-no" title="statement not covered" >      handler = <span class="fstat-no" title="function not covered" >fu</span>nction () {};</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.removeExternalUserId(handler);</span>
  }
&nbsp;
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setInAppMessageClickHandler(
...
<span class="cstat-no" title="statement not covered" >    isValidCallback(handler);</span>
<span class="cstat-no" title="statement not covered" >    RNOneSignal.initInAppMessageClickHandlerParams();</span>
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setInAppMessageClickHandler();</span>
<span class="cstat-no" title="statement not covered" >    eventManager.setEventHandler&lt;InAppMessageAction&gt;(</span>
      IN_APP_MESSAGE_CLICKED,
      handler,
    );
  }
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setInAppMessageLifecycleHandler(
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (handlerObject.onWillDisplayInAppMessage) {</span>
<span class="cstat-no" title="statement not covered" >      isValidCallback(handlerObject.onWillDisplayInAppMessage);</span>
<span class="cstat-no" title="statement not covered" >      eventManager.setEventHandler&lt;InAppMessage&gt;(</span>
        IN_APP_MESSAGE_WILL_DISPLAY,
        handlerObject.onWillDisplayInAppMessage,
      );
    }
<span class="cstat-no" title="statement not covered" >    if (handlerObject.onDidDisplayInAppMessage) {</span>
<span class="cstat-no" title="statement not covered" >      isValidCallback(handlerObject.onDidDisplayInAppMessage);</span>
<span class="cstat-no" title="statement not covered" >      eventManager.setEventHandler&lt;InAppMessage&gt;(</span>
        IN_APP_MESSAGE_DID_DISPLAY,
        handlerObject.onDidDisplayInAppMessage,
      );
    }
<span class="cstat-no" title="statement not covered" >    if (handlerObject.onWillDismissInAppMessage) {</span>
<span class="cstat-no" title="statement not covered" >      isValidCallback(handlerObject.onWillDismissInAppMessage);</span>
<span class="cstat-no" title="statement not covered" >      eventManager.setEventHandler&lt;InAppMessage&gt;(</span>
        IN_APP_MESSAGE_WILL_DISMISS,
        handlerObject.onWillDismissInAppMessage,
      );
    }
<span class="cstat-no" title="statement not covered" >    if (handlerObject.onDidDismissInAppMessage) {</span>
<span class="cstat-no" title="statement not covered" >      isValidCallback(handlerObject.onDidDismissInAppMessage);</span>
<span class="cstat-no" title="statement not covered" >      eventManager.setEventHandler&lt;InAppMessage&gt;(</span>
        IN_APP_MESSAGE_DID_DISMISS,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setInAppMessageLifecycleHandler();</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic addTrigger(key: string, value: string | number | boolean): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    // value can be assigned to `false` so we cannot just check `!value`
<span class="cstat-no" title="statement not covered" >    if (!key || value == null) {</span>
<span class="cstat-no" title="statement not covered" >      console.error('OneSignal: addTrigger: must include a key and a value');</span>
    }
&nbsp;
    let trigger: { [key: string]: string | number | boolean } = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >    trigger[key] = value;</span>
<span class="cstat-no" title="statement not covered" >    RNOneSignal.addTriggers(trigger);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic addTriggers(triggers: {
...
&nbsp;
    let keys = <span class="cstat-no" title="statement not covered" >Object.keys(triggers);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (keys.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >      console.error(</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.addTriggers(triggers);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic removeTriggersForKeys(keys: string[]): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.removeTriggersForKeys(keys);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic removeTriggerForKey(key: string): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    RNOneSignal.removeTriggerForKey(key);</span>
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  st</span>atic getTriggerValueForKey(
    key: string,
...
<span class="cstat-no" title="statement not covered" >    return RNOneSignal.getTriggerValueForKey(key);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic pauseInAppMessages(pause: boolean): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    RNOneSignal.pauseInAppMessages(pause);</span>
  }
&nbsp;
  /* O U T C O M E S */
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic sendOutcome(
    name: string,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.sendOutcome(name, handler);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic sendUniqueOutcome(
    name: string,
    handler?: (event: OutcomeEvent) =&gt; void,
  ): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.sendUniqueOutcome(name, handler);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic sendOutcomeWithValue(
    name: string,
    value: string | number,
    handler?: (event: OutcomeEvent) =&gt; void,
  ): void {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.sendOutcomeWithValue(name, Number(value), handler);</span>
  }
&nbsp;
...
&nbsp;
   ...
   * @returns Promise&lt;boolean&gt;
   */
<span class="fstat-no" title="function not covered" >  st</span>atic userProvidedPrivacyConsent(): Promise&lt;boolean&gt; {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return Promise.resolve(false);</span>
    }
&nbsp;
    //returns a promise
<span class="cstat-no" title="statement not covered" >    return RNOneSignal.userProvidedPrivacyConsent();</span>
  }
&nbsp;
  /**
   ...
   * @returns Promise&lt;boolean&gt;
   */
<span class="fstat-no" title="function not covered" >  st</span>atic requiresUserPrivacyConsent(): Promise&lt;boolean&gt; {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return Promise.resolve(false);</span>
    }
&nbsp;
    //returns a promise
<span class="cstat-no" title="statement not covered" >    return RNOneSignal.requiresUserPrivacyConsent();</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setRequiresUserPrivacyConsent(required: boolean): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setRequiresUserPrivacyConsent(required);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic provideUserConsent(granted: boolean): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.provideUserConsent(granted);</span>
  }
&nbsp;
...
&nbsp;
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic setLogLevel(nsLogLevel: LogLevel, visualLogLevel: LogLevel): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    RNOneSignal.setLogLevel(nsLogLevel, visualLogLevel);</span>
  }
&nbsp;
  /**
   ...
   * @returns void
   */
<span class="fstat-no" title="function not covered" >  st</span>atic clearHandlers(): void {
<span class="cstat-no" title="statement not covered" >    if (!isNativeModuleLoaded(RNOneSignal)) {</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
<span class="cstat-no" title="statement not covered" >    eventManager.clearHandlers();</span>
  }
}
&nbsp;
