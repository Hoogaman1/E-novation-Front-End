Arguments: 
  /opt/homebrew/Cellar/node/18.8.0/bin/node /opt/homebrew/Cellar/yarn/1.22.19/libexec/bin/yarn.js

PATH: 
  /opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Applications/VMware Fusion Tech Preview.app/Contents/Public:/usr/local/share/dotnet:/usr/local/munki:~/.dotnet/tools:/Library/Apple/usr/bin:/Library/Frameworks/Mono.framework/Versions/Current/Commands
...
Trace: 
  SyntaxError: /Users/henryboswell/Developer/react-native-onesignal/package.json: Unexpected token } in JSON at position 315
...
npm manifest: 
  {
    ...
    "scripts": {
      ...
      "build": "tsc",
      "lint": "eslint src --ext .js,.jsx,.ts,.tsx; prettier --check src __test__",
    },
    "dependencies": {
      "invariant": "^2.2.2"
    },
...
Lockfile: 
  ...
  "@babel/types@^7.18.10", "@babel/types@^7.18.13", "@babel/types@^7.18.6", "@babel/types@^7.18.9", "@babel/types@^7.7.0":
    version "7.18.13"
